    ...
    VALUE *argv;
{
    ...
    for (i = 0; i < argc; i++)
	argv[0] = py2rb(PyTuple_GET_ITEM(tuple, i));
}
...
{
    PyObject *m, *d;
    VALUE dummy_class, top_self, cRbMethod;
    ...
    dummy_class = rb_define_class_id(rb_intern("DummyClass"), rb_cObject);
    dummy_value = Data_Wrap_Struct(dummy_class, mark_all_rbobjects,
				   0, NULL);
